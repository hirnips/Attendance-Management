...
Public Class attendancecrystal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Proect_Work.attendancecrystal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedattendancecrystal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As attendancecrystal = New attendancecrystal
        rpt.Site = Me.Site
        Return rpt
    End Function
