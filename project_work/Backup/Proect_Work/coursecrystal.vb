...
Public Class coursecrystal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Proect_Work.coursecrystal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcoursecrystal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As coursecrystal = New coursecrystal
        rpt.Site = Me.Site
        Return rpt
    End Function
