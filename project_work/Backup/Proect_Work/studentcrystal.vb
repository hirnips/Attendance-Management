...
Public Class studentcrystal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Proect_Work.studentcrystal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedstudentcrystal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As studentcrystal = New studentcrystal
        rpt.Site = Me.Site
        Return rpt
    End Function
