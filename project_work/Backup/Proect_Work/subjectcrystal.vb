...
Public Class subjectcrystal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Proect_Work.subjectcrystal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsubjectcrystal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As subjectcrystal = New subjectcrystal
        rpt.Site = Me.Site
        Return rpt
    End Function
